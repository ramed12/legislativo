...
class BaseRepository implements BaseRepositoryInterface
{
    ...
    public function listProposicoes($request, $orderByField, $orderByOrder, $paginate, $tipo=null) {
            ...
            if (in_array($field, $fillable)) {
                ...
                switch ($field) {
                    ...
                    case 'deleted_at':
                        ...
                        break;
                    case 'ementa':
                           $model->where($field, "REGEXP", "$novoFiltro");
        ...
        if(isset($filter)){
            ...
            foreach($filter as $row){
                ...
                foreach($model->get() as $b){
                    $ab = [
                        "id_proposicao" => $b->id_api,
                        "palavra" => $row
                    ];

                    PalavrasBusca::create($ab);
                }
            }
        }
