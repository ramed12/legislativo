...
<body  style="margin-top: 0; margin-bottom: 0; padding-top: 0; padding-bottom: 0; width: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; background-color:rgb(52, 62, 158)">
                ...
                <tr>
                    <td align="center"  bgcolor="#343e9e" class="container-padding">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                        <tr>
                                            ...
                                            <!-- column -->
                                                ...
                                                <!-- column -->
                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" style="">
                                                    <tr  >
                                                        <td align="left" class="center-text">
                                                            <a href="{{ url('/') }}"><img style="width:152px;border:0px;display: inline!important;" src="{{ asset('imagens/logo1_white.png') }}" width="152" border="0"       alt="logo"></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                            ...
                            <tr  >
                                <td class="center-text"  align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">

                                    <div  >
                                        Olá, <b>Administrador</b> uma nova tramitação está disponível no sistema<BR>
                                        <hr>
                                        <div class=''>
                                           Autoria do(a) Dep. <a href="{!! route('parlamentar.show', $parlamentar->nano_id) !!}"<b>{!! $parlamentar->name !!}</b> <BR>
                                           Tipo: {!! $proposicao->tipo !!} <BR> <Br>
                                           Ementa: {!! $proposicao->ementa !!} <BR> <BR>
                                           Arquivo: <a style="font-weight:bolder; text-decoration:underline" target="_BLANK" href="https://www.al.mt.gov.br/storage/webdisco/cp/{!! $proposicao->arquivo !!}">Baixar</a>
                                           <hr>
                                           Movimentação: {!! $tramitacao['descricao'] !!} <BR>
                                           Setor: {!! $tramitacao['setor'] !!} <BR>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                                        <tr>
                                            <td align="center"    bgcolor="#d6df58" style="border-radius: 6px;">
                                                ...
                                                <a href="{!! route('tramitacao', $proposicao->id_api) !!}" target="_blank"    style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>Visualizar</span></a>
